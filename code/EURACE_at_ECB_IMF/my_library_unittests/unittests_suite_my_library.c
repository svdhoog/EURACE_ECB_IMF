...
int main(int argc, char * argv[])
{
    ...
    */
    ...
    if(
     	//CU_add_test(pSuite, "Random_int", unittest_random_int) == NULL //||
        //CU_add_test(pSuite, "my_stats_mean", unittest_my_stats_mean) == NULL ||
        //CU_add_test(pSuite, "my_stats_sd", unittest_my_stats_sd) == NULL //||
        //CU_add_test(pSuite, "inverse_gaussian", unittest_inverse_gaussian) == NULL //||
        //CU_add_test(pSuite, "multivariate_gaussian", unittest_multivariate_gaussian) == NULL //||
        CU_add_test(pSuite, "max_exp", unittest_max_exp) == NULL //|| 
    )
    {
        CU_cleanup_registry();
        return CU_get_error();
