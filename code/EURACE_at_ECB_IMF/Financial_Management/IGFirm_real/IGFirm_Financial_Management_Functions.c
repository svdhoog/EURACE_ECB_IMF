...
int IGFirm_execute_financial_payments()
{
   ...
   else
   {
    ...
    {
	    printf("\nIGFirm_execute_financial_payments");
...
int IGFirm_bankruptcy_insolvency_procedure()
{
    ...
    count_fire = RESEARCH_EMPLOYEES.size;
    reset_employee_array(&RESEARCH_EMPLOYEES);
