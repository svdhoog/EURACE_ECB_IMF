...
*/
    ...
    else fprintf(stderr, "\n Financial/Household_aux_Functions.c, logit_decision_model: In logit_decision_model: performance sum is zero.\n");
    ...
    else fprintf(stderr, "\n Financial/Household_aux_Functions.c, logit_decision_model: In logit_decision_model: Proportion sum is zero.\n");
